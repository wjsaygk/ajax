...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/resource/images/dogg.gif');">
			<div class="wrap-login100">
				<form action="/join" method="post" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						<input type="submit"  name="submit"  class="login100-form-btn" value="회원가입">
					
						<input type=reset name=reset class="login100-form-btn"  value="다시입력"> 
					</div>
